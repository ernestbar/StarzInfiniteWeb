<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporte_broker_adm.aspx.cs" Inherits="StarzInfiniteWeb.reporte_broker_adm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ObjectDataSource ID="odsReporteBroker" runat="server" SelectMethod="PR_OBTIENE_REPORTE_BROKER" TypeName="StarzInfiniteWeb.LocalBD">
		 <SelectParameters>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <div>
						<table id="tblData" class="table table-bordered order-table ">
									...
									<tbody>
												<asp:Repeater ID="Repeater1" DataSourceID="odsReporteBroker" runat="server">
													<ItemTemplate>
														<tr>
															<td>
															...
															<td>
																<asp:Label ID="Label28" runat="server" Text='<%# Eval("COMISION_BROKER") %>'></asp:Label>
															</td>
                                                            <td>
